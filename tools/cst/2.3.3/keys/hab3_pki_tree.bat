...
:GEN_WTLS
:: Convert SRK certs
..\windows\x5092wtls.exe --cert=..\crts\SRK%i%_sha256_%kl%_65537_v3_ca_crt.pem ^
--key=.\%ca_key% ^
-w ..\crts\SRK%i%_sha256_%kl%_65537_v3_ca_crt.der ^
-p .\key_pass.txt

:: Convert CSF crts
..\windows\x5092wtls.exe --cert=..\crts\CSF%i%_1_sha256_%kl%_65537_v3_ca_crt.pem ^
--key=.\SRK%i%_sha256_%kl%_65537_v3_ca_key.pem ^
-w ..\crts\CSF%i%_1_sha256_%kl%_65537_v3_ca_crt.der ^
-p .\key_pass.txt

:: Convert IMG certs
..\windows\x5092wtls.exe --cert=..\crts\IMG%i%_1_sha256_%kl%_65537_v3_usr_crt.pem ^
--key=.\CSF%i%_1_sha256_%kl%_65537_v3_ca_key.pem ^
-w ..\crts\IMG%i%_1_sha256_%kl%_65537_v3_ca_crt.der ^
-p .\key_pass.txt
...
echo +++++++++++++++++++++++++++++++++++++
echo.
..\windows\srktool.exe --hab_ver=3 --certs=%srk_list% --o > ..\crts\srktool_wtls.txt
