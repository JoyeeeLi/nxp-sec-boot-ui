...
class advSettingsWin_FlexibleUserKeys ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText_regionSel = wx.StaticText( self.m_panel_encryptionOpt, wx.ID_ANY, u"Region Selection:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_regionSel.Wrap( -1 )

		gSizer_encryptionOpt.Add( self.m_staticText_regionSel, 0, wx.ALL, 5 )

		m_choice_regionSelChoices = [ u"Region 0", u"Region 1", u"Both Regions" ]
		self.m_choice_regionSel = wx.Choice( self.m_panel_encryptionOpt, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_regionSelChoices, 0 )
		self.m_choice_regionSel.SetSelection( 0 )
		gSizer_encryptionOpt.Add( self.m_choice_regionSel, 0, wx.ALL, 5 )

		self.m_staticText_keyProperty = wx.StaticText( self.m_panel_encryptionOpt, wx.ID_ANY, u"Key Property:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_keyProperty.Wrap( -1 )

		gSizer_encryptionOpt.Add( self.m_staticText_keyProperty, 0, wx.ALL, 5 )

		m_choice_keyPropertyChoices = [ u"Random Key", u"Zero Key" ]
		self.m_choice_keyProperty = wx.Choice( self.m_panel_encryptionOpt, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_keyPropertyChoices, 0 )
		self.m_choice_keyProperty.SetSelection( 0 )
		gSizer_encryptionOpt.Add( self.m_choice_keyProperty, 0, wx.ALL, 5 )

		self.m_staticText_imageType = wx.StaticText( self.m_panel_encryptionOpt, wx.ID_ANY, u"Image Type:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_imageType.Wrap( -1 )

		gSizer_encryptionOpt.Add( self.m_staticText_imageType, 0, wx.ALL, 5 )
		...
		self.m_panel_region0Info = wx.Panel( self.m_notebook_regionInfo, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		gSizer_region0Info = wx.GridSizer( 0, 2, 0, 0 )

		self.m_staticText_region0keySource = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"Key Source:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0keySource.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0keySource, 0, wx.ALL, 5 )

		m_choice_region0keySourceChoices = [ u"Fuse OTPMK[255:128]", u"Fuse GP4[127:0]", u"Fuse SW-GP2" ]
		self.m_choice_region0keySource = wx.Choice( self.m_panel_region0Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region0keySourceChoices, 0 )
		self.m_choice_region0keySource.SetSelection( 1 )
		gSizer_region0Info.Add( self.m_choice_region0keySource, 0, wx.ALL, 5 )

		self.m_staticText_region0UserKeyData = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"User Key Data:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0UserKeyData.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0UserKeyData, 0, wx.ALL, 5 )

		self.m_textCtrl_region0UserKeyData = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, u"0123456789abcdef0123456789ABCDEF", wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0UserKeyData, 0, wx.ALL, 5 )

		self.m_staticText_region0AesMode = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"AES Mode:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region0AesMode = wx.Choice( self.m_panel_region0Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region0AesModeChoices, 0 )
		self.m_choice_region0AesMode.SetSelection( 1 )
		gSizer_region0Info.Add( self.m_choice_region0AesMode, 0, wx.ALL, 5 )

		self.m_staticText_region0FacCnt = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC Region Count:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region0FacCnt = wx.Choice( self.m_panel_region0Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region0FacCntChoices, 0 )
		self.m_choice_region0FacCnt.SetSelection( 0 )
		gSizer_region0Info.Add( self.m_choice_region0FacCnt, 0, wx.ALL, 5 )

		self.m_staticText_region0Fac0Start = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC0 Region Start (eg. 0x60001000):", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0Fac0Start.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0Fac0Start, 0, wx.ALL, 5 )

		self.m_textCtrl_region0Fac0Start = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0Fac0Start, 0, wx.ALL, 5 )

		self.m_staticText_region0Fac0Length = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC0 Region Length (eg. 0x1000):", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0Fac0Length.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0Fac0Length, 0, wx.ALL, 5 )

		self.m_textCtrl_region0Fac0Length = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0Fac0Length, 0, wx.ALL, 5 )

		self.m_staticText_region0Fac1Start = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC1 Region Start:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0Fac1Start.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0Fac1Start, 0, wx.ALL, 5 )

		self.m_textCtrl_region0Fac1Start = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0Fac1Start, 0, wx.ALL, 5 )

		self.m_staticText_region0Fac1Length = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC1 Region Length:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0Fac1Length.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0Fac1Length, 0, wx.ALL, 5 )

		self.m_textCtrl_region0Fac1Length = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0Fac1Length, 0, wx.ALL, 5 )

		self.m_staticText_region0Fac2Start = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC2 Region Start:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0Fac2Start.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0Fac2Start, 0, wx.ALL, 5 )

		self.m_textCtrl_region0Fac2Start = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0Fac2Start, 0, wx.ALL, 5 )

		self.m_staticText_region0Fac2Length = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"FAC2 Region Length:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region0Fac2Length.Wrap( -1 )

		gSizer_region0Info.Add( self.m_staticText_region0Fac2Length, 0, wx.ALL, 5 )

		self.m_textCtrl_region0Fac2Length = wx.TextCtrl( self.m_panel_region0Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region0Info.Add( self.m_textCtrl_region0Fac2Length, 0, wx.ALL, 5 )

		self.m_staticText_region0AccessPermision = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"Access Permision:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region0AccessPermision = wx.Choice( self.m_panel_region0Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region0AccessPermisionChoices, 0 )
		...
		self.m_staticText_region0Lock = wx.StaticText( self.m_panel_region0Info, wx.ID_ANY, u"Region Lock:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region0Lock = wx.Choice( self.m_panel_region0Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region0LockChoices, 0 )
		...
		self.m_notebook_regionInfo.AddPage( self.m_panel_region0Info, u"Encrypted Region 0 Info", True )
		self.m_panel_region1Info = wx.Panel( self.m_notebook_regionInfo, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		gSizer_region1Info = wx.GridSizer( 0, 2, 0, 0 )

		self.m_staticText_region1keySource = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"Key Source:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1keySource.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1keySource, 0, wx.ALL, 5 )

		m_choice_region1keySourceChoices = [ u"Fuse OTPMK[255:128]", u"Fuse GP4[127:0]", u"Fuse SW-GP2" ]
		self.m_choice_region1keySource = wx.Choice( self.m_panel_region1Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region1keySourceChoices, 0 )
		self.m_choice_region1keySource.SetSelection( 1 )
		gSizer_region1Info.Add( self.m_choice_region1keySource, 0, wx.ALL, 5 )

		self.m_staticText_region1UserKeyData = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"User Key Data:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1UserKeyData.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1UserKeyData, 0, wx.ALL, 5 )

		self.m_textCtrl_region1UserKeyData = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, u"0123456789abcdef0123456789ABCDEF", wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1UserKeyData, 0, wx.ALL, 5 )

		self.m_staticText_region1AesMode = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"AES Mode:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region1AesMode = wx.Choice( self.m_panel_region1Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region1AesModeChoices, 0 )
		self.m_choice_region1AesMode.SetSelection( 1 )
		gSizer_region1Info.Add( self.m_choice_region1AesMode, 0, wx.ALL, 5 )

		self.m_staticText_region1FacCnt = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC Region Count:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region1FacCnt = wx.Choice( self.m_panel_region1Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region1FacCntChoices, 0 )
		self.m_choice_region1FacCnt.SetSelection( 0 )
		gSizer_region1Info.Add( self.m_choice_region1FacCnt, 0, wx.ALL, 5 )

		self.m_staticText_region1Fac0Start = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC0 Region Start (eg. 0x60001000):", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1Fac0Start.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1Fac0Start, 0, wx.ALL, 5 )

		self.m_textCtrl_region1Fac0Start = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1Fac0Start, 0, wx.ALL, 5 )

		self.m_staticText_region1Fac0Length = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC0 Region Length (eg. 0x1000):", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1Fac0Length.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1Fac0Length, 0, wx.ALL, 5 )

		self.m_textCtrl_region1Fac0Length = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1Fac0Length, 0, wx.ALL, 5 )

		self.m_staticText_region1Fac1Start = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC1 Region Start:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1Fac1Start.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1Fac1Start, 0, wx.ALL, 5 )

		self.m_textCtrl_region1Fac1Start = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1Fac1Start, 0, wx.ALL, 5 )

		self.m_staticText_region1Fac1Length = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC1 Region Length:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1Fac1Length.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1Fac1Length, 0, wx.ALL, 5 )

		self.m_textCtrl_region1Fac1Length = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1Fac1Length, 0, wx.ALL, 5 )

		self.m_staticText_region1Fac2Start = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC2 Region Start:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1Fac2Start.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1Fac2Start, 0, wx.ALL, 5 )

		self.m_textCtrl_region1Fac2Start = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1Fac2Start, 0, wx.ALL, 5 )

		self.m_staticText_region1Fac2Length = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"FAC2 Region Length:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_region1Fac2Length.Wrap( -1 )

		gSizer_region1Info.Add( self.m_staticText_region1Fac2Length, 0, wx.ALL, 5 )

		self.m_textCtrl_region1Fac2Length = wx.TextCtrl( self.m_panel_region1Info, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 220,-1 ), 0 )
		gSizer_region1Info.Add( self.m_textCtrl_region1Fac2Length, 0, wx.ALL, 5 )

		self.m_staticText_region1AccessPermision = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"Access Permision:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region1AccessPermision = wx.Choice( self.m_panel_region1Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region1AccessPermisionChoices, 0 )
		...
		self.m_staticText_region1Lock = wx.StaticText( self.m_panel_region1Info, wx.ID_ANY, u"Region Lock:", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_choice_region1Lock = wx.Choice( self.m_panel_region1Info, wx.ID_ANY, wx.DefaultPosition, wx.Size( 220,-1 ), m_choice_region1LockChoices, 0 )
		...
		self.m_notebook_regionInfo.AddPage( self.m_panel_region1Info, u"Encrypted Region 1 Info", False )

		wSizer_win.Add( self.m_notebook_regionInfo, 1, wx.EXPAND |wx.ALL, 5 )

		self.m_staticText_winNull0 = wx.StaticText( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 234,-1 ), 0 )
